...
export function ProfileCard({
  ...
  return (
    <motion.div
      ...
      className="group w-full max-w-2xl p-4 mb-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md cursor-pointer transition-all"
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-1 justify-between items-start gap-3 min-w-0">
          ...
          <button
            ...
            className={`shrink-0 self-start flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg transition-colors ${
              isSaved
